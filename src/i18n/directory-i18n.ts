...
export const directoryLabels = {
  pageTitle: {
    ...
    br: "Diretório de simulação de voo",
  ...
  pageDescription: {
    ...
    br: "Descubra comunidades, companhias aéreas virtuais, desenvolvedores de add-ons e recursos de simulação de voo ao redor do mundo.",
  ...
  navLabel: {
    en: "Directory", fr: "Annuaire", es: "Directorio", pt: "Diretório", br: "Diretório",
    de: "Verzeichnis", zh: "目录", id: "Direktori", ja: "ディレクトリ",
  },
  continents: {
    europe: {
      en: "Europe", fr: "Europe", es: "Europa", pt: "Europa", br: "Europa",
      de: "Europa", zh: "欧洲", id: "Eropa", ja: "ヨーロッパ",
    },
    "north-america": {
      en: "North America", fr: "Amérique du Nord", es: "América del Norte", pt: "América do Norte", br: "América do Norte",
      de: "Nordamerika", zh: "北美洲", id: "Amerika Utara", ja: "北アメリカ",
    },
    "south-america": {
      en: "South America", fr: "Amérique du Sud", es: "América del Sur", pt: "América do Sul", br: "América do Sul",
      de: "Südamerika", zh: "南美洲", id: "Amerika Selatan", ja: "南アメリカ",
    },
    asia: {
      en: "Asia", fr: "Asie", es: "Asia", pt: "Ásia", br: "Ásia",
      de: "Asien", zh: "亚洲", id: "Asia", ja: "アジア",
    },
    oceania: {
      en: "Oceania", fr: "Océanie", es: "Oceanía", pt: "Oceania", br: "Oceania",
      de: "Ozeanien", zh: "大洋洲", id: "Oseania", ja: "オセアニア",
    },
    africa: {
      en: "Africa", fr: "Afrique", es: "África", pt: "África", br: "África",
      de: "Afrika", zh: "非洲", id: "Afrika", ja: "アフリカ",
    },
  },
  categories: {
    "virtual-airline": {
      en: "Virtual Airlines", fr: "Compagnies virtuelles", es: "Aerolíneas virtuales", pt: "Companhias aéreas virtuais", br: "Companhias aéreas virtuais",
      de: "Virtuelle Fluggesellschaften", zh: "虚拟航空公司", id: "Maskapai Virtual", ja: "バーチャルエアライン",
    },
    community: {
      en: "Communities & Forums", fr: "Communautés et forums", es: "Comunidades y foros", pt: "Comunidades e fóruns", br: "Comunidades e fóruns",
      de: "Communities und Foren", zh: "社区与论坛", id: "Komunitas dan Forum", ja: "コミュニティとフォーラム",
    },
    training: {
      en: "Training & Schools", fr: "Formations et écoles", es: "Formación y escuelas", pt: "Treinamento e escolas", br: "Treinamento e escolas",
      de: "Schulung und Ausbildung", zh: "培训与学校", id: "Pelatihan dan Sekolah", ja: "トレーニングとスクール",
    },
    "addon-developer": {
      en: "Addon Developers", fr: "Développeurs d'add-ons", es: "Desarrolladores de add-ons", pt: "Desenvolvedores de add-ons", br: "Desenvolvedores de add-ons",
      de: "Addon-Entwickler", zh: "插件开发者", id: "Pengembang Add-on", ja: "アドオン開発者",
    },
    event: {
      en: "Events & Fly-ins", fr: "Événements et fly-in", es: "Eventos y fly-in", pt: "Eventos e fly-in", br: "Eventos e fly-in",
      de: "Events und Fly-ins", zh: "活动与飞行聚会", id: "Acara dan Fly-in", ja: "イベントとフライイン",
    },
    media: {
      en: "Media & Content Creators", fr: "Médias et créateurs", es: "Medios y creadores", pt: "Mídia e criadores", br: "Mídia e criadores",
      de: "Medien und Creator", zh: "媒体与内容创作者", id: "Media dan Kreator Konten", ja: "メディアとクリエイター",
    },
    network: {
      en: "ATC Networks", fr: "Réseaux ATC", es: "Redes ATC", pt: "Redes ATC", br: "Redes ATC",
      de: "ATC-Netzwerke", zh: "空管网络", id: "Jaringan ATC", ja: "ATCネットワーク",
    },
    shop: {
      en: "Shops & Hardware", fr: "Boutiques et matériel", es: "Tiendas y hardware", pt: "Lojas e hardware", br: "Lojas e hardware",
      de: "Shops und Hardware", zh: "商店与硬件", id: "Toko dan Perangkat Keras", ja: "ショップとハードウェア",
    },
  },
  ui: {
    resources: {
      en: "resources", fr: "ressources", es: "recursos", pt: "recursos", br: "recursos",
      de: "Ressourcen", zh: "个资源", id: "sumber daya", ja: "件のリソース",
    },
    countries: {
      en: "countries", fr: "pays", es: "países", pt: "países", br: "países",
      de: "Länder", zh: "个国家", id: "negara", ja: "カ国",
    },
    verified: {
      en: "Verified", fr: "Vérifié", es: "Verificado", pt: "Verificado", br: "Verificado",
      de: "Verifiziert", zh: "已验证", id: "Terverifikasi", ja: "確認済み",
    },
    featured: {
      en: "Featured", fr: "En vedette", es: "Destacado", pt: "Destaque", br: "Destaque",
    ...
    suggestResource: {
      ...
      br: "Conhece um recurso que está faltando? Nos avise!",
    ...
    lastUpdated: {
      en: "Last updated", fr: "Dernière mise à jour", es: "Última actualización", pt: "Última atualização", br: "Última atualização",
      de: "Zuletzt aktualisiert", zh: "最后更新", id: "Terakhir diperbarui", ja: "最終更新",
    },
    completeDirectory: {
      en: "Complete Directory", fr: "Annuaire complet", es: "Directorio completo", pt: "Diretório completo", br: "Diretório completo",
...
export type SiteLang = "en" | "fr" | "es" | "pt" | "br" | "de" | "zh" | "id" | "ja";
