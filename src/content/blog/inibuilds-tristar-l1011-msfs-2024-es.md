...
Ahora, más de medio siglo después, **iniBuilds** está trayendo el L-1011-500 TriStar a **Microsoft Flight Simulator 2024**. El proyecto se encuentra en las fases finales de desarrollo, y lo que hemos visto hasta ahora sugiere que estamos ante una de las recreaciones de avión clásico más ambiciosas jamás intentadas en el ecosistema de MSFS. No hay fecha de lanzamiento confirmada ni precio anunciado todavía, pero la profundidad técnica que ya se ha revelado merece un análisis exhaustivo.
